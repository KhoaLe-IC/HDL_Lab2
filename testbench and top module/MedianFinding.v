module MedianFinding(
    input clk,
    input [7:0]pixel_0, pixel_1, pixel_2, pixel_3, pixel_4, pixel_5, pixel_6, pixel_7, pixel_8,
    ...
    always @(posedge clk) begin
        ...
        pipe1[5] <= (pixel_5 > pixel_0)? pixel_5 : pixel_0;
        pipe1[0] <= (pixel_5 > pixel_0)? pixel_0 : pixel_5;
        
        pipe1[6] <= (pixel_6 > pixel_1)? pixel_6 : pixel_1;
        pipe1[1] <= (pixel_6 > pixel_1)? pixel_1 : pixel_6;

        pipe1[7] <= (pixel_7 > pixel_2)? pixel_7 : pixel_2;
        pipe1[2] <= (pixel_7 > pixel_2)? pixel_2 : pixel_7;
        
        pipe1[8] <= (pixel_8 > pixel_3)? pixel_8 : pixel_3;
        pipe1[3] <= (pixel_8 > pixel_3)? pixel_3 : pixel_8;
    end
